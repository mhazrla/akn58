...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?= form_open("product/update", ['class' => "store-data"]) ?>
                <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" placeholder="Nama Produk" name="nama" id="nama" value="<?= $nama ?>">
                                <div class="invalid-feedback errorNamaProduk" style="display: none;"></div>
                            </div>
                            <div class="col-4">
                                <label for="name">Stok</label>
                                <input type="number" class="form-control" placeholder="0" name="stok" id="stok" value="<?= $stok ?>">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" placeholder="Rp100,000" name="harga_beli" id="harga_beli" value="<?= $harga_beli ?>">
                                <div class="invalid-feedback errorHargaBeli" style="display: none;"></div>
                            </div>
                            <div class="col">
                                <label for="name">Harga jual</label>
                                <input type="text" class="form-control" placeholder="Rp100,000" name="harga_jual" id="harga_jual" value="<?= $harga_jual ?>">
